...
\end{ocamldoccode}
\index{get-underscorelast@\verb`get_last`}
\begin{ocamldocdescription}
...
\end{ocamldoccode}
\index{rm-underscorelast@\verb`rm_last`}
\begin{ocamldocdescription}
...
\end{ocamldoccode}
\index{str-underscorerev@\verb`str_rev`}
\begin{ocamldocdescription}
...
\end{ocamldoccode}
\index{ends-underscorewith@\verb`ends_with`}
\begin{ocamldocdescription}
...
\end{ocamldoccode}
\index{common-underscoreprefix@\verb`common_prefix`}
\begin{ocamldocdescription}
...
\end{ocamldoccode}
\index{is-underscoreprimitive@\verb`is_primitive`}
\begin{ocamldocdescription}
...
\end{ocamldoccode}
\index{is-underscorewide@\verb`is_wide`}
\begin{ocamldocdescription}
...
\end{ocamldoccode}
\index{is-underscoreinner-underscoreclass@\verb`is_inner_class`}
\begin{ocamldocdescription}
...
\end{ocamldoccode}
\index{get-underscoreowning-underscoreclass@\verb`get_owning_class`}
\begin{ocamldocdescription}
...
val c_void : string
\end{ocamldoccode}
\index{c-underscorevoid@\verb`c_void`}
\begin{ocamldocdescription}
{\tt{java.lang.Void}}
...
val c_bool : string
\end{ocamldoccode}
\index{c-underscorebool@\verb`c_bool`}
\begin{ocamldocdescription}
{\tt{java.lang.Boolean}}
...
val c_byte : string
\end{ocamldoccode}
\index{c-underscorebyte@\verb`c_byte`}
\begin{ocamldocdescription}
{\tt{java.lang.Byte}}
...
\label{val:Java.Lang.c-underscoreshort}\begin{ocamldoccode}
val c_short : string
\end{ocamldoccode}
\index{c-underscoreshort@\verb`c_short`}
\begin{ocamldocdescription}
{\tt{java.lang.Short}}
...
\label{val:Java.Lang.c-underscorechar}\begin{ocamldoccode}
val c_char : string
\end{ocamldoccode}
\index{c-underscorechar@\verb`c_char`}
\begin{ocamldocdescription}
...
\label{val:Java.Lang.c-underscoreint}\begin{ocamldoccode}
val c_int : string
\end{ocamldoccode}
\index{c-underscoreint@\verb`c_int`}
\begin{ocamldocdescription}
{\tt{java.lang.Integer}}
...
\label{val:Java.Lang.c-underscorelong}\begin{ocamldoccode}
val c_long : string
\end{ocamldoccode}
\index{c-underscorelong@\verb`c_long`}
\begin{ocamldocdescription}
{\tt{java.lang.Long}}
...
\label{val:Java.Lang.c-underscorefloat}\begin{ocamldoccode}
val c_float : string
\end{ocamldoccode}
\index{c-underscorefloat@\verb`c_float`}
\begin{ocamldocdescription}
{\tt{java.lang.Float}}
...
\label{val:Java.Lang.c-underscoredoubl}\begin{ocamldoccode}
val c_doubl : string
\end{ocamldoccode}
\index{c-underscoredoubl@\verb`c_doubl`}
\begin{ocamldocdescription}
{\tt{java.lang.Double}}
...
\label{val:Java.Lang.start}\begin{ocamldoccode}
val start : string
\end{ocamldoccode}
...
\end{ocamldoccode}
\index{of-underscorereg@\verb`of_reg`}
\begin{ocamldocdescription}
...
type reg_sort =
  ...
  | R_NORMAL
\end{ocamldoccode}
\index{reg-underscoresort@\verb`reg_sort`}
\begin{ocamldocdescription}
...
\end{ocamldoccode}
\index{get-underscorereg-underscoresorts@\verb`get_reg_sorts`}
\begin{ocamldocdescription}
...
\end{ocamldoccode}
\index{new-underscoreist-underscoreof@\verb`new_ist_of`}
\begin{ocamldocdescription}
...
\end{ocamldoccode}
\index{new-underscoregoto@\verb`new_goto`}
\begin{ocamldocdescription}
...
\end{ocamldoccode}
\index{new-underscoreif@\verb`new_if`}
\begin{ocamldocdescription}
...
\end{ocamldoccode}
\index{new-underscorebin-underscoreop@\verb`new_bin_op`}
\begin{ocamldocdescription}
...
\end{ocamldoccode}
\index{new-underscorebin-underscorelit-underscoreop@\verb`new_bin_lit_op`}
\begin{ocamldocdescription}
...
\end{ocamldoccode}
\index{new-underscoreun-underscoreop@\verb`new_un_op`}
\begin{ocamldocdescription}
...
\end{ocamldoccode}
\index{new-underscoreist-underscorefld@\verb`new_ist_fld`}
\begin{ocamldocdescription}
...
\label{module:Dex.IdxKey}\index{IdxKey@\verb`IdxKey`}
...
\label{module:Dex.OffKey}\index{OffKey@\verb`OffKey`}
...
\end{ocamldoccode}
\index{chk-underscoreacc-underscoreflag@\verb`chk_acc_flag`}
\begin{ocamldocdescription}
...
\end{ocamldoccode}
\index{is-underscorestatic@\verb`is_static`}
\begin{ocamldocdescription}
...
\end{ocamldoccode}
\index{is-underscoresynthetic@\verb`is_synthetic`}
\begin{ocamldocdescription}
...
\end{ocamldoccode}
\index{get-underscorefld-underscorefull-underscorename@\verb`get_fld_full_name`}
\begin{ocamldocdescription}
...
\end{ocamldoccode}
\index{get-underscoremtd-underscorefull-underscorename@\verb`get_mtd_full_name`}
\begin{ocamldocdescription}
...
\end{ocamldoccode}
\index{get-underscoremtd-underscoresig@\verb`get_mtd_sig`}
\begin{ocamldocdescription}
...
\end{ocamldoccode}
\index{get-underscoreimplementers@\verb`get_implementers`}
\begin{ocamldocdescription}
...
\end{ocamldoccode}
\index{is-underscoreinnerclass@\verb`is_innerclass`}
\begin{ocamldocdescription}
...
\end{ocamldoccode}
\index{get-underscoreinnerclasses@\verb`get_innerclasses`}
\begin{ocamldocdescription}
...
\end{ocamldoccode}
\index{get-underscorestt-underscoreflds@\verb`get_stt_flds`}
\begin{ocamldocdescription}
...
\end{ocamldoccode}
\index{is-underscoreparam@\verb`is_param`}
\begin{ocamldocdescription}
...
\end{ocamldoccode}
\index{skip-underscorecls@\verb`skip_cls`}
\begin{ocamldocdescription}
...
\end{ocamldoccode}
\index{get-underscoreskip-underscorecls@\verb`get_skip_cls`}
\begin{ocamldocdescription}
...
\end{ocamldoccode}
\index{skip-underscoremtd@\verb`skip_mtd`}
\begin{ocamldocdescription}
...
\end{ocamldoccode}
\index{get-underscoreskip-underscoremtd@\verb`get_skip_mtd`}
\begin{ocamldocdescription}
...
\end{ocamldoccode}
\index{set-underscoreskip-underscorepkgs@\verb`set_skip_pkgs`}
\begin{ocamldocdescription}
...
\end{ocamldoccode}
\index{to-underscorebe-underscoreskipped@\verb`to_be_skipped`}
\begin{ocamldocdescription}
...
val lst_act : string
\end{ocamldoccode}
\index{lst-underscoreact@\verb`lst_act`}
\begin{ocamldocdescription}
...
val tab_act : string
\end{ocamldoccode}
\index{tab-underscoreact@\verb`tab_act`}
\begin{ocamldocdescription}
...
\label{val:Android.App.onStart}\begin{ocamldoccode}
val onStart : string
\end{ocamldoccode}
\index{onStart@\verb`onStart`}
\begin{ocamldocdescription}
{\tt{onStart}}
...
\label{val:Android.App.onStop}\begin{ocamldoccode}
val onStop : string
\end{ocamldoccode}
\index{onStop@\verb`onStop`}
\begin{ocamldocdescription}
{\tt{onStop}}
...
\end{ocamldoccode}
\index{onCreateOptionsMenu@\verb`onCreateOptionsMenu`}
\begin{ocamldocdescription}
...
val set_view : string
\end{ocamldoccode}
\index{set-underscoreview@\verb`set_view`}
\begin{ocamldocdescription}
{\tt{setContentView}}
...
\label{val:Android.App.find-underscoreview}\begin{ocamldoccode}
val find_view : string
\end{ocamldoccode}
\index{find-underscoreview@\verb`find_view`}
\begin{ocamldocdescription}
{\tt{findViewById}}
...
\label{val:Android.App.lifecycle-underscoreact}\begin{ocamldoccode}
val lifecycle_act : string list
\end{ocamldoccode}
\index{lifecycle-underscoreact@\verb`lifecycle_act`}
\begin{ocamldocdescription}
{\tt{Activity}} lifecycle methods


\end{ocamldocdescription}


\label{val:Android.App.lifecycle-underscoresrv}\begin{ocamldoccode}
val lifecycle_srv : string list
\end{ocamldoccode}
\index{lifecycle-underscoresrv@\verb`lifecycle_srv`}
\begin{ocamldocdescription}
{\tt{Service}} lifecycle methods
...
\end{ocamldoccode}
\index{set-underscoreclass@\verb`set_class`}
\begin{ocamldocdescription}
{\tt{setClass}}
...
\end{ocamldoccode}
\index{start-underscoreact@\verb`start_act`}
\begin{ocamldocdescription}
{\tt{startActivity}}
...
\end{ocamldoccode}
\index{start-underscoresrv@\verb`start_srv`}
\begin{ocamldocdescription}
{\tt{startService}}
...
\end{ocamldoccode}
\index{is-underscorestatic-underscorelibrary@\verb`is_static_library`}
\begin{ocamldocdescription}
...
\end{ocamldoccode}
\index{is-underscorecontext@\verb`is_context`}
\begin{ocamldocdescription}
...
\end{ocamldoccode}
\index{is-underscoreactivity@\verb`is_activity`}
\begin{ocamldocdescription}
...
\end{ocamldoccode}
\index{is-underscorefragment@\verb`is_fragment`}
\begin{ocamldocdescription}
...
\end{ocamldoccode}
\index{is-underscorelistener@\verb`is_listener`}
\begin{ocamldocdescription}
...
\end{ocamldoccode}
\index{find-underscorelifecycle-underscoreact@\verb`find_lifecycle_act`}
\begin{ocamldocdescription}
...
\end{ocamldoccode}
\index{is-underscoreset-underscorelistener@\verb`is_set_listener`}
\begin{ocamldocdescription}
...
\label{module:Android.Ads}\index{Ads@\verb`Ads`}
...
\end{ocamldoccode}
\index{is-underscoreads-underscorepkg@\verb`is_ads_pkg`}
\begin{ocamldocdescription}
...
\end{ocamldoccode}
\index{api-underscoreusage@\verb`api_usage`}
\begin{ocamldocdescription}
...
\end{ocamldoccode}
\index{add-underscorecall@\verb`add_call`}
\begin{ocamldocdescription}
...
\end{ocamldoccode}
\index{make-underscorepartial-underscorecg@\verb`make_partial_cg`}
\begin{ocamldocdescription}
...
\end{ocamldoccode}
\index{compare-underscorecc@\verb`compare_cc`}
\begin{ocamldocdescription}
...
\end{ocamldoccode}
\index{has-underscorecaller@\verb`has_caller`}
\begin{ocamldocdescription}
...
\end{ocamldoccode}
\index{get-underscorelast-underscoreinss@\verb`get_last_inss`}
\begin{ocamldocdescription}
...
\end{ocamldoccode}
\index{val-underscoreto-underscorestr@\verb`val_to_str`}
\begin{ocamldocdescription}
...
\label{module:Reaching}\index{Reaching@\verb`Reaching`}
...
\end{ocamldoccode}
\index{new-underscoresig@\verb`new_sig`}
\begin{ocamldocdescription}
...
\end{ocamldoccode}
\index{get-underscorecursor@\verb`get_cursor`}
\begin{ocamldocdescription}
...
\end{ocamldoccode}
\index{get-underscorefst-underscorecursor@\verb`get_fst_cursor`}
\begin{ocamldocdescription}
...
\end{ocamldoccode}
\index{get-underscorelast-underscorecursor@\verb`get_last_cursor`}
\begin{ocamldocdescription}
...
val insrt_insns_under_off :
  ...
  Dex.code_item -> cursor -> Instr.instr list -> cursor
\end{ocamldoccode}
\index{insrt-underscoreinsns-underscoreunder-underscoreoff@\verb`insrt_insns_under_off`}
\begin{ocamldocdescription}
...
val insrt_insns_over_off :
  ...
  Dex.code_item -> cursor -> Instr.instr list -> cursor
\end{ocamldoccode}
\index{insrt-underscoreinsns-underscoreover-underscoreoff@\verb`insrt_insns_over_off`}
\begin{ocamldocdescription}
...
\end{ocamldoccode}
\index{shift-underscorereg-underscoreusage@\verb`shift_reg_usage`}
\begin{ocamldocdescription}
...
\end{ocamldoccode}
\index{shift-underscoreparams@\verb`shift_params`}
\begin{ocamldocdescription}
...
\end{ocamldoccode}
\index{rename-underscorecls@\verb`rename_cls`}
\begin{ocamldocdescription}
...
\end{ocamldoccode}
\index{discard-underscorecls-underscorecalls@\verb`discard_cls_calls`}
\begin{ocamldocdescription}
...
\end{ocamldoccode}
\index{expand-underscoreopr@\verb`expand_opr`}
\begin{ocamldocdescription}
...
\label{module:Testing}\index{Testing@\verb`Testing`}
...
\end{ocamldoccode}
\index{add-underscoretransition@\verb`add_transition`}
\begin{ocamldocdescription}
