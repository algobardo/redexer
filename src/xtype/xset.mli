...
module type XSET_TYPE =
  sig
    ...
    *)
    ...
    (** [delim] is the string used to delimit elements of the set in
	string representations of the set. *)
    val delim : string

    (** [lb] is the string used as the left boundary in string
	representations of the set. *)
    val lb : string

    (** [rb] is the string used as the right boundary in string
	representations of the set. *)
    val rb : string
